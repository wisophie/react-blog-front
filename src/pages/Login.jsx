    ...
    <Loginstyled>
      ...
      <animated.div style={animatedTexts[0]} className={!lgclick ? 'login-wrap' : 'login-wrap dpnone'}>
        <div className='login-box'>
          ...
          <div className={click ? 'login-wxlogin' : 'login-norm'}>
            <div className='login-content'>
              ...
              >
                ...
                <Form.Item>
                  ...
                  <div className='login-reg'>或现在<Link to='/register' className='register'>注册</Link> !
                  </div>
                </Form.Item>
              </Form>
            </div>
            ...
            <div onClick={wxloginshow} className='login-wxback'>取消</div>
          </div>
      ...
      <footer>
        <div className='logo'>
          ...
          <Tooltip title="Nodejs" overlayClassName='tooltips'><img src={nodejs} alt="" /></Tooltip>
